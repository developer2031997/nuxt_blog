<template>
    <div>
        ...
        <div class="container px-2 max-w-screen-xl flex flex-wrap items-center justify-between mx-auto">
            ...
            <!-- Navigation Links -->
            <div :class="{ 'block': isOpen, 'hidden': !isOpen }" class=" w-full md:block md:w-auto" id="navbar-default">
        ...
        <footer class="menubar-bg py-2">
            <div class="container text-center">
                <h1 class="font-2xl text-white font-bold">
                    Copyright © {{ new Date() . getFullYear() }} Medical Blogs.
                </h1>
            </div>
        </footer>
    </div>
...
<style scoped>
    ...
    .sticky-nav {
        ...
        width: 100%;
        z-index: 1000;
        transition: fadeInOut 0.3s ease;
    }
